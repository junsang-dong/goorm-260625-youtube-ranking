...
const routes = [
  ...
  { method: 'POST', pattern: /^\/api\/analyze-channel$/, loader: () => loadHandler('../api/analyze-channel.js') },
  { method: 'POST', pattern: /^\/api\/filter-channels$/, loader: () => loadHandler('../api/filter-channels.js') },
